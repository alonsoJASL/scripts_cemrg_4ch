...
CMD="cp ${UACFOLDER}/la/la.nod ${UACFOLDER}/la/la_fibres_l_tags.nod;cp ${UACFOLDER}/la/la.eidx ${UACFOLDER}/la/la_fibres_l_tags.eidx"
eval $CMD

CMD="cp ${UACFOLDER}/ra/ra.nod ${UACFOLDER}/ra/ra_fibres_l_tags.nod;cp ${UACFOLDER}/ra/ra.eidx ${UACFOLDER}/ra/ra_fibres_l_tags.eidx"
eval $CMD

CMD="meshtool insert submesh -submsh=${UACFOLDER}/la/la_fibres_l_tags -msh=${UACFOLDER}/biatrial/biatrial -ofmt=carp_txt -outmsh=${UACFOLDER}/biatrial/biatrial_la_fibres"
eval $CMD

CMD="meshtool convert -imsh=${UACFOLDER}/biatrial/biatrial_la_fibres -omsh=${UACFOLDER}/biatrial/biatrial_la_fibres.vtk"
eval $CMD

CMD="meshtool insert submesh -submsh=${UACFOLDER}/ra/ra_fibres_l_tags -msh=${UACFOLDER}/biatrial/biatrial_la_fibres -ofmt=carp_txt -outmsh=${UACFOLDER}/biatrial/biatrial_fibres_l"
eval $CMD
...
CMD="meshtool insert submesh -submsh=${UACFOLDER}/biatrial/biatrial_fibres_l -msh=${FCH} -ofmt=carp_txt -outmsh=${FCH}_fibres_l"
eval $CMD

CMD="meshtool convert -imsh=${FCH}_fibres_l -omsh=${FCH}_fibres_l.vtk"
eval $CMD
...
def main(args):
	...
	meshtool_extract_surfaces(mesh,surf_folder,input_tags)
	...
	meshtool_extract_la(mesh,surf_folder_la,input_tags)
	...
	meshtool_extract_ra(mesh,surf_folder_ra,input_tags)

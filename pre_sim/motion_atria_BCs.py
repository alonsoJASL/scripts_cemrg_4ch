...
def main(args):
  ...
  json_settings = "./atria_map_settings.json"
  ...
  # settings = [-3.15, -2.09, -1.54, 0, -0.1, 0.7, 3.15]
  # Iz = [0., 0.4, 0.7, 1.0]

  # df_pts   = pandas.read_csv(args.mesh+'.pts', skiprows=1, delimiter=' ', header=None)
  # pts      = df_pts.values

  # df_elem = pandas.read_csv(args.mesh + '.elem', skiprows=1, delimiter=' ', header=None)

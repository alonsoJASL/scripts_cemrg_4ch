...
from process_handler import clean_segmentation_refact

def main(args) :
    """
    Clean segmentation from points
    USAGE:
    python3 clean_seg.py [path_to_points] [--points-json [points_json]] [--origin-spacing-json [origin_spacing_json]] [OPTIONS]
...
if __name__ == '__main__' : 
    parser = argparse.ArgumentParser(description='To run: python3 clean_seg.py [path_to_points]', usage=main.__doc__)

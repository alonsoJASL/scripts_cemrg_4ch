...
def main(args) : 
    ...
    seg_s3r_array = img.connected_component(DIR('seg_s3p.nrrd'), Ao_wall_tip_seed, C.Ao_wall_label,path2points)
    ...
    seg_s3s_array = img.connected_component(DIR('seg_s3r.nrrd'), PArt_wall_tip_seed, C.PArt_wall_label,path2points)
    ...
    dmap_label = ('LA_BP', C.LA_BP_label)
    thresh_label = ('LA_BP_thresh', C.valve_WT)
    and_replace_label = [C.LV_BP_label, C.MV_label]
    ...
    dmap_label = ('LV_myo', C.LV_myo_label)
    thresh_label = ('LV_myo_extra', C.LA_WT)
    and_replace_label = [C.LA_BP_label,C.LA_myo_label]
    ...
    dmap_label = ('RA_BP', C.RA_BP_label)
    thresh_label = ('RA_BP_thresh', C.valve_WT)
    and_replace_label = [C.RV_BP_label, C.TV_label]
    ...
    dmap_label = ('RA_myo', C.RA_myo_label)
    thresh_label = ('RA_myo_extra', C.RA_WT)
    and_replace_label = [C.RA_BP_label,C.RA_myo_label]
    ...
    dmap_label = ('Ao_BP', C.Ao_BP_label)
    thresh_label = ('AV', C.valve_WT)
    and_replace_label = [C.LV_BP_label, C.AV_label]
    ...
    Ao_wall_extra = img.threshold_filter_nrrd(TMP('LV_myo_DistMap.nrrd'),0,C.Ao_WT)
    ...
    Ao_wall_extra_array = img.and_filter(seg_s4e_array,Ao_wall_extra_array,C.Ao_BP_label,C.Ao_wall_label)
    seg_s4f_array = img.add_masks_replace(seg_s4e_array,Ao_wall_extra_array,C.Ao_wall_label)
    ...
    AV_DistMap = img.distance_map(DIR('seg_s4f.nrrd'),C.AV_label)
    print(' ## AV: Writing temporary image ## \n')
    sitk.WriteImage(AV_DistMap,TMP('AV_DistMap.nrrd'),True)

    print(' ## AV: Thresholding distance filter ## \n')
    AV_sep = img.threshold_filter_nrrd(TMP('AV_DistMap.nrrd'),0,2*C.valve_WT)
    ...
    AV_sep_array = img.and_filter(seg_s4f_array,AV_sep_array,C.MV_label,C.LV_myo_label)
    seg_s4f_array = img.add_masks_replace(seg_s4f_array,AV_sep_array,C.LV_myo_label)
    ...
    print(' ## MV corrections: Closing holes around the mitral valve ## \n')
    print(' ## MV corrections: Executing distance map ## \n')
    LV_myo_DistMap = img.distance_map(DIR('seg_s4f.nrrd'),C.LV_myo_label)
    print(' ## MV corrections: Writing temporary image ## \n')
    sitk.WriteImage(LV_myo_DistMap,TMP('LV_myo_DistMap.nrrd'),True)

    print(' ## MV corrections: Thresholding distance filter ## \n')
    LA_myo_extra = img.threshold_filter_nrrd(TMP('LV_myo_DistMap.nrrd'),0,C.LA_WT)
    ...
    LA_myo_extra_array = img.and_filter(seg_s4ff_array,LA_myo_extra_array,C.LA_BP_label,C.LA_myo_label)
    seg_s4ff_array = img.add_masks_replace(seg_s4ff_array,LA_myo_extra_array,C.LA_myo_label)
    ...
    PArt_BP_DistMap = img.distance_map(DIR('seg_s4ff.nrrd'),C.PArt_BP_label)
    ...
    PV = img.threshold_filter_nrrd(TMP('PArt_BP_DistMap.nrrd'),0,C.valve_WT)
    ...
    PV_array = img.and_filter(seg_s4ff_array,PV_array,C.RV_BP_label,C.PV_label)
    seg_s4g_array = img.add_masks_replace(seg_s4ff_array,PV_array,C.PV_label)
    ...
    PArt_wall_extra = img.threshold_filter_nrrd(TMP('RV_myo_DistMap.nrrd'),0,C.PArt_WT)
    ...
    PArt_wall_extra_array = img.and_filter(seg_s4g_array,PArt_wall_extra_array,C.PArt_BP_label,C.PArt_wall_label)
    seg_s4h_array = img.add_masks_replace(seg_s4g_array,PArt_wall_extra_array,C.PArt_wall_label)
    ...
    LA_myo_DistMap = img.distance_map(DIR('seg_s4h.nrrd'),C.LA_myo_label)
    RA_myo_DistMap = img.distance_map(DIR('seg_s4h.nrrd'),C.RA_myo_label)
    ...
    LA_myo_thresh = img.threshold_filter_nrrd(TMP('LA_myo_DistMap.nrrd'),0,C.ring_thickness)
    RA_myo_thresh = img.threshold_filter_nrrd(TMP('RA_myo_DistMap.nrrd'),0,C.ring_thickness)
    ...
    LPV1_BP_DistMap = img.distance_map(DIR('seg_s4h.nrrd'),C.LPV1_label)
    ...
    LPV1_ring = img.threshold_filter_nrrd(TMP('LPV1_BP_DistMap.nrrd'),0,C.ring_thickness)
    ...
    seg_s4i_array = img.add_masks(seg_s4h_array,LPV1_ring_array,C.LPV1_ring_label)

    LPV1_ring_array = img.and_filter(seg_s4i_array,LA_myo_thresh_array,C.LPV1_ring_label,C.LPV1_ring_label)
    seg_s4j_array = img.add_masks_replace(seg_s4h_array,LPV1_ring_array,C.LPV1_ring_label)
    ...
    LPV2_BP_DistMap = img.distance_map(DIR('seg_s4h.nrrd'),C.LPV2_label)
    ...
    LPV2_ring = img.threshold_filter_nrrd(TMP('LPV2_BP_DistMap.nrrd'),0,C.ring_thickness)
    ...
    seg_s4i_array = img.add_masks(seg_s4i_array,LPV2_ring_array,C.LPV2_ring_label)

    LPV2_ring_array = img.and_filter(seg_s4i_array,LA_myo_thresh_array,C.LPV2_ring_label,C.LPV2_ring_label)
    seg_s4j_array = img.add_masks_replace(seg_s4j_array,LPV2_ring_array,C.LPV2_ring_label)
    ...
    RPV1_BP_DistMap = img.distance_map(DIR('seg_s4h.nrrd'),C.RPV1_label)
    ...
    RPV1_ring = img.threshold_filter_nrrd(TMP('RPV1_BP_DistMap.nrrd'),0,C.ring_thickness)
    ...
    seg_s4i_array = img.add_masks_replace_only(seg_s4i_array,RPV1_ring_array,C.RPV1_ring_label,C.SVC_label)

    RPV1_ring_array = img.and_filter(seg_s4i_array,LA_myo_thresh_array,C.RPV1_ring_label,C.RPV1_ring_label)
    seg_s4j_array = img.add_masks_replace(seg_s4j_array,RPV1_ring_array,C.RPV1_ring_label)
    ...
    RPV2_BP_DistMap = img.distance_map(DIR('seg_s4h.nrrd'),C.RPV2_label)
    ...
    RPV2_ring = img.threshold_filter_nrrd(TMP('RPV2_BP_DistMap.nrrd'),0,C.ring_thickness)
    ...
    seg_s4i_array = img.add_masks(seg_s4i_array,RPV2_ring_array,C.RPV2_ring_label)

    RPV2_ring_array = img.and_filter(seg_s4i_array,LA_myo_thresh_array,C.RPV2_ring_label,C.RPV2_ring_label)
    seg_s4j_array = img.add_masks_replace(seg_s4j_array,RPV2_ring_array,C.RPV2_ring_label)
    ...
    LAA_BP_DistMap = img.distance_map(DIR('seg_s4h.nrrd'),C.LAA_label)
    ...
    LAA_ring = img.threshold_filter_nrrd(TMP('LAA_BP_DistMap.nrrd'),0,C.ring_thickness)
    ...
    seg_s4i_array = img.add_masks(seg_s4i_array,LAA_ring_array,C.LAA_ring_label)

    LAA_ring_array = img.and_filter(seg_s4i_array,LA_myo_thresh_array,C.LAA_ring_label,C.LAA_ring_label)
    seg_s4j_array = img.add_masks_replace(seg_s4j_array,LAA_ring_array,C.LAA_ring_label)
    ...
    SVC_BP_DistMap = img.distance_map(DIR('seg_s4h.nrrd'),C.SVC_label)
    ...
    SVC_ring = img.threshold_filter_nrrd(TMP('SVC_BP_DistMap.nrrd'),0,C.ring_thickness)
    ...
    seg_s4i_array = img.add_masks_replace_only(seg_s4i_array,SVC_ring_array,C.SVC_ring_label,C.Ao_wall_label)
    seg_s4i_array = img.add_masks_replace_only(seg_s4i_array,SVC_ring_array,C.SVC_ring_label,C.LA_myo_label)
    seg_s4i_array = img.add_masks_replace_only(seg_s4i_array,SVC_ring_array,C.SVC_ring_label,C.RPV1_ring_label)
    seg_s4i_array = img.add_masks_replace_only(seg_s4i_array,SVC_ring_array,C.SVC_ring_label,C.RPV1_label)

    SVC_ring_array = img.and_filter(seg_s4i_array,RA_myo_thresh_array,C.SVC_ring_label,C.SVC_ring_label)
    seg_s4j_array = img.add_masks_replace(seg_s4j_array,SVC_ring_array,C.SVC_ring_label)
    ...
    IVC_BP_DistMap = img.distance_map(DIR('seg_s4h.nrrd'),C.IVC_label)
    ...
    IVC_ring = img.threshold_filter_nrrd(TMP('IVC_BP_DistMap.nrrd'),0,C.ring_thickness)
    ...
    seg_s4i_array = img.add_masks(seg_s4i_array,IVC_ring_array,C.IVC_ring_label)

    IVC_ring_array = img.and_filter(seg_s4i_array,RA_myo_thresh_array,C.IVC_ring_label,C.IVC_ring_label)
    seg_s4j_array = img.add_masks_replace(seg_s4j_array,IVC_ring_array,C.IVC_ring_label)
    ...
    plane_LPV1_array = img.and_filter(seg_s4j_array,LA_BP_thresh_array,C.LPV1_label,C.plane_LPV1_label)
    seg_s4k_array = img.add_masks_replace(seg_s4j_array,plane_LPV1_array,C.plane_LPV1_label)

    # ----------------------------------------------------------------------------------------------
    # Creating plane for LPV2
    # ----------------------------------------------------------------------------------------------
    print(' ## Valve planes: LPV2 ## \n')
    plane_LPV2_array = img.and_filter(seg_s4k_array,LA_BP_thresh_array,C.LPV2_label,C.plane_LPV2_label)
    seg_s4k_array = img.add_masks_replace(seg_s4k_array,plane_LPV2_array,C.plane_LPV2_label)

    # ----------------------------------------------------------------------------------------------
    # Creating plane for RPV1
    # ----------------------------------------------------------------------------------------------
    print(' ## Valve planes: RPV1 ## \n')
    plane_RPV1_array = img.and_filter(seg_s4k_array,LA_BP_thresh_array,C.RPV1_label,C.plane_RPV1_label)
    seg_s4k_array = img.add_masks_replace(seg_s4k_array,plane_RPV1_array,C.plane_RPV1_label)

    # ----------------------------------------------------------------------------------------------
    # Creating plane for RPV2
    # ----------------------------------------------------------------------------------------------
    print(' ## Valve planes: RPV2 ## \n')
    plane_RPV2_array = img.and_filter(seg_s4k_array,LA_BP_thresh_array,C.RPV2_label,C.plane_RPV2_label)
    seg_s4k_array = img.add_masks_replace(seg_s4k_array,plane_RPV2_array,C.plane_RPV2_label)

    # ----------------------------------------------------------------------------------------------
    # Creating plane for LAA
    # ----------------------------------------------------------------------------------------------
    print(' ## Valve planes: LAA ## \n')
    plane_LAA_array = img.and_filter(seg_s4k_array,LA_BP_thresh_array,C.LAA_label,C.plane_LAA_label)
    seg_s4k_array = img.add_masks_replace(seg_s4k_array,plane_LAA_array,C.plane_LAA_label)

    # ----------------------------------------------------------------------------------------------
    # Creating plane for SVC
    # ----------------------------------------------------------------------------------------------
    print(' ## Valve planes: SVC ## \n')
    RA_BP_thresh_2mm = img.threshold_filter_nrrd(TMP('RA_BP_DistMap.nrrd'),0,C.valve_WT_svc_ivc)
    ...
    plane_SVC_array = img.and_filter(seg_s4k_array,RA_BP_thresh_2mm_array,C.SVC_label,C.plane_SVC_label)
    plane_SVC_extra_array = img.and_filter(seg_s4k_array,RA_BP_thresh_2mm_array,C.RPV1_ring_label,C.plane_SVC_label)
    seg_s4k_array = img.add_masks_replace(seg_s4k_array,plane_SVC_array,C.plane_SVC_label)
    seg_s4k_array = img.add_masks_replace(seg_s4k_array,plane_SVC_extra_array,C.plane_SVC_label)

    # ----------------------------------------------------------------------------------------------
    # Creating plane for IVC
    # ----------------------------------------------------------------------------------------------
    print(' ## Valve planes: IVC ## \n')
    plane_IVC_array = img.and_filter(seg_s4k_array,RA_BP_thresh_2mm_array,C.IVC_label,C.plane_IVC_label)
    seg_s4k_array = img.add_masks_replace(seg_s4k_array,plane_IVC_array,C.plane_IVC_label)
